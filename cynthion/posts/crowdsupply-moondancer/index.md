...
While the Embedded Rust community has made great strides towards supporting RISC-V architectures we were in a bit of a strange place as we needed to support a relatively obscure soft-core CPU combined with user-defined peripherals in a custom SoC design.
...
One of our first jobs was therefore to extend our LunaSoC library with the ability to export SVD files generated directly from the SoC design.
