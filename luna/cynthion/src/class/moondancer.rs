...
impl core::convert::From<u32> for Moondancer {
    fn from(verb: u32) -> Self {
        match verb {
            0x0 => Moondancer::connect,
            0x1 => Moondancer::disconnect,
            0x2 => Moondancer::bus_reset,
            0x3 => Moondancer::set_address,
            0x4 => Moondancer::set_up_endpoints,
            0x5 => Moondancer::get_status,
            0x6 => Moondancer::read_setup,
            0x7 => Moondancer::stall_endpoint,
            0x8 => Moondancer::send_on_endpoint,
            0x9 => Moondancer::clean_up_transfer,
            0x10 => Moondancer::start_nonblocking_read,
            0x11 => Moondancer::finish_nonblocking_read,
            0x12 => Moondancer::get_nonblocking_data_length,
            _ => Moondancer::unsupported(verb),
        }
    }
}

impl core::convert::From<U32<LittleEndian>> for Moondancer {
    fn from(value: U32<LittleEndian>) -> Self {
        Moondancer::from(value.get())
    }
}
...
impl Dispatch {
    pub fn handle(&self, class: super::Class, verb: Moondancer) -> &[u8] {
        match verb {
            Moondancer::connect => connect(),
            _ => {
